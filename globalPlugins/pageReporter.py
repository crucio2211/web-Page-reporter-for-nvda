...
def _rolesFromFields(ti):
    try:
        ...
        for item in fields:
            ...
            # NVDA quick-nav (H, K, F, B, D) traverses ALL virtual buffer nodes
            # including invisible and offscreen ones. Remove all visibility filtering
            # so our counts match what NVDA actually navigates.
